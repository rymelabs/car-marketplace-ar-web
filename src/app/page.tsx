...
import { FilterIcon } from "@/components/icons/feather-icons";
      ...
      <main className="min-h-screen bg-[linear-gradient(140deg,_#fff7ed_0%,_#f8fafc_44%,_#ecfeff_100%)] pb-14">
        ...
        <section className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
          <details className="group">
            <summary className="inline-flex cursor-pointer list-none items-center gap-2 rounded-full bg-slate-900 px-5 py-2.5 text-sm font-semibold text-white hover:bg-amber-500 hover:text-slate-950">
              <FilterIcon className="h-4 w-4" />
              <span>Filters</span>
              <span className="inline-block text-xs transition-transform group-open:rotate-180">▼</span>
            </summary>

            <form className="mt-3 grid gap-3 rounded-2xl border border-slate-200 bg-white p-4 md:grid-cols-5">
